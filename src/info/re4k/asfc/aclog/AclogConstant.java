...
public interface AclogConstant{
	...
	public static final String user_favorites = base+"/api/tweets/user_favorites.json";
	public static final String user_favorited_by = base+"/api/tweets/user_favorited_by.json";
